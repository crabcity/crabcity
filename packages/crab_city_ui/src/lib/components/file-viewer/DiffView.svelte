<script lang="ts">
  ...
  let { diffData, diffEngine, actualEngine, refreshStatus, showRefreshOverlay, onengineToggle }: Props = $props();
    ...
    {#each hunk.lines as line}
      <div class="diff-line {line.type}">
        ...
        <span class="line-content"
          >{#each splitByHighlights(line.content, line.highlights) as seg}{#if seg.highlighted}<mark class="inline-hl"
                >{seg.text}</mark
